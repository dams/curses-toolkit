				...
				Curses::Toolkit::Widget::Border->new() # space
					...
					Curses::Toolkit::Widget::VBox->new()->pack_end(
						Curses::Toolkit::Widget::HBox->new()->pack_end(
							my $button01 =
								Curses::Toolkit::Widget::Button->new_with_label('This is a button !')
								->set_name('button1'),
							{ expand => 1 }
							)
							...
							$button02 =
								...
								->set_name('button2')->add_event_listener(
						...
						Curses::Toolkit::Widget::HBox->new()->pack_end(
							my $button1 =
								Curses::Toolkit::Widget::Button->new_with_label('This button is there!')
								->set_name('button1'),
							{ expand => 0 }
							)
							...
							->pack_end(
							my $button2 =
								Curses::Toolkit::Widget::Button->new_with_label('Yet Another Button !')
								->set_name('button2'),
							{ expand => 0 }
							),
