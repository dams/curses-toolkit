...
sub main {
	...
	my $window;
	$root->add_window( $window = Curses::Toolkit::Widget::Window->new()->set_name('window')->set_title("a title") );
	...
	my $label2 = Curses::Toolkit::Widget::Label->new->set_text(
		"This is <span fgcolor='blue'>in blue, <span bgcolor='red'>red background </span> and blue again</span> chunk");
